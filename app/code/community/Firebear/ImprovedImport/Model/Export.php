...
class Firebear_ImprovedImport_Model_Export extends Mage_Dataflow_Model_Convert_Parser_Abstract
{
    protected $_fields;
...
//                    $this->_fields[$j] = 'column'.($j+1);
    ...
    public function unparse()
    {
        ...
        /*  Multiple images export  start*/
        $export_column = Mage::getStoreConfig('improvedimport/imagesexport/multiple_image_export_column_name');

        $fieldList[$export_column] = $export_column;
        /* Multiple images export finish*/
